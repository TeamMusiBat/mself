...
import youtube_dl
#SEMOGA BERMANFAAT,,,1s3 RIRIN..


cl = LineClient("amord9500@gmail.com","amor2341")
...
poll = LinePoll(cl)
call = cl
creator = ["ue3d4ef5946b294a7e2c654127d0290c1"]
owner = ["ue3d4ef5946b294a7e2c654127d0290c1"]
admin = ["ue3d4ef5946b294a7e2c654127d0290c1"]
staff = ["ue3d4ef5946b294a7e2c654127d0290c1"]
...
def help():
    ...
    key = key.title()
    helpMessage = "[]" + key + " [[┄┅═CANNIBAL BOT PROTECT═┅┄]]\n" + \
                   "[]" + key + "[[MENU CANNIBAL]]\n" + \
                   "[]" + key + "ʜᴇʟᴘ\n" + \
                   "[]" + key + "ʜᴇʟᴘ1\n" + \
                   "[]" + key + "ʜᴇʟᴘ2\n" + \
...
def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "❂͜͡➣ " + key + " [[┄┅═CANNIBAL BOT PROTECT═┅┄]]\n" + \
                  "❂͜͡➣ " + key + "ᴛᴀɢᴀʟʟ/ɴᴀʜ\n" + \
                  "❂͜͡➣ " + key + "ɢɪɴғᴏ\n" + \
                  "❂͜͡➣ " + key + "ᴏᴘᴇɴ\n" + \
                  "❂͜͡➣ " + key + "ᴄʟᴏsᴇ\n" + \
                  ...
                  "「」  ʙʏ: [[┄┅═CANNIBAL BOT PROTECT═┅┄]]\n" + \
                  "  Creator: https://line.me/ti/p/IAHDhBMdRW "
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                ret_ += "\nRIRIN BOTS"
                                ret_ += "\nCreator:  https://line.me/ti/p/-ebfwpiU9P"
...
">>>BYE BYE><\nMAU DENDAM CARI KAMI\n<<<<<<<<<>>\nhttps://line.me/ti/p/-ebfwpiU9P")
                        ...
                        elif cmd == "dragon" or cmd == "ririn":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[🔰 RIRIN TEAM BOT].")
                               elapsed_time = time.time() - start
...
">>>BYEE-BYEE<..\nLU DENDAM GUE TUNGGU\n<<<<<<<<<>>\nhttps://line.me/ti/p/-ebfwpiU9P")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[🔰 HADIR]1")
                                ki.sendMessage(msg.to, "[🔰 HADIR]2")
                                kk.sendMessage(msg.to, "[🔰 HADIR]3")
                                kc.sendMessage(msg.to, "[🔰 HADIR]4")
                                kb.sendMessage(msg.to, "[🔰 HADIR]5")
                                kd.sendMessage(msg.to, "[🔰 HADIR]6")
                                ke.sendMessage(msg.to, "[🔰 HADIR]7")
                                kf.sendMessage(msg.to, "[🔰 HADIR]8")
                                kg.sendMessage(msg.to, "[🔰 HADIR]9")
                                kh.sendMessage(msg.to, "[🔰 HADIR]10")
                                cl.sendMessage(msg.to, "╔═══╗\n║╔═╗║\n║║─║╠╗╔╦══╦═╗\n║╚═╝║╚╝║╔╗║╔╗╗\n║╔═╗║║║║╔╗║║║║\n╚╝─╚╩╩╩╩╝╚╩╝╚╝")
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "Pasukan Ririn Hadir")
                                ki.sendMessage(msg.to, "Pasukan Ririn Hadir")
                                kk.sendMessage(msg.to, "Pasukan Ririn Hadir")
                                kc.sendMessage(msg.to, "Pasukan Ririn Hadir")
                                kb.sendMessage(msg.to, "Pasukan Ririn Hadir")
                                kd.sendMessage(msg.to, "Pasukan Ririn Hadir")
                                ke.sendMessage(msg.to, "Pasukan Ririn Hadir")
                                kf.sendMessage(msg.to, "Pasukan Ririn Hadir")
                                kg.sendMessage(msg.to, "Pasukan Ririn Hadir")
                                kh.sendMessage(msg.to, "Pasukan Ririn Hadir")
                                cl.sendMessage(msg.to, "All pasukan Ririn Hdir\nAmankan Room\nDemi Amanat Bos Q")
