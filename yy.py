...
poll = LinePoll(cl)
call = cl
creator = ["ud8c615e041bf9fc539416e14984ccc35"]
owner = ["ud8c615e041bf9fc539416e14984ccc35"]
admin = ["ud8c615e041bf9fc539416e14984ccc35"]
staff = ["ud8c615e041bf9fc539416e14984ccc35"]
...
wait = {
    ...
    "welcome":"รεℓαɱαт ∂αтαɳɠ \nɓµ∂αყαҡαɳ ૮εҡ ɳσтε.\nรεɱσɠα ɓεтαɦ ∂เ รเɳเ\n\n⊠➠ɴᴏ ʙᴀᴘᴇʀ \n⊠➠ɴᴏ ʀᴜsᴜʜ \n⊠➠ɴᴏ ᴛɪᴋᴜɴɢ \n⊠➠ɴᴏ ᴘᴏʀɴᴏ \n⊠➠ɴᴏ ʀᴀsɪs\n\nᴄᴏɴᴛᴀᴄᴛ ᴍᴇ➠ line.me/ti/p/~shahzain786",
    "leave":"See you next againt later",
    "comment":"╔═Super Dupar",
    "message":"Thanks 4 Add Me",
}
read = {
    "readPoint":{},
    "readMember":{},
...
def help1():
    ...
    helpMessage1 = "      「✭SELF BOT✭」\n" + \
                  ...
                  "⟗   ⃢🕸ʙʏ: 􀰂􀰂✍͡➴͜ოυȿἶβąƮ➣➻🕸 ⃢   ⟗\n" + \
                  "  Creator:  line.me/ti/p/~shahzain786\n"
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                ret_ += "\n• ❂➣ ɴᴀᴍe ɢʀᴜᴘ : {}".format(str(ginfo.name))
                                ret_ += "\n• ❂➣ ᴡᴀᴋᴛᴜ ɴɢɪʀɪᴍ: {}".format(dt_to_str(cTime_to_datetime(msg_dict[msg_id]["createdTime"])))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                cl.sendText("u3e4c348df350746f2dd436d84ba719bb", '.')
                                elapsed_time = time.time() - start
                                ryan = cl.getContact(mid)
                                zx = ""
                                zxc = ""
                                zx2 = []
                                xpesan =  "「 ɪɴғᴏʀᴍᴀsɪon sᴇʟғʙᴏᴛ 」\n• ✡༎⎑  ༓ᴜsᴇʀ : "
